...
@router.post("/register", dependencies=[Depends(get_current_active_superuser)], response_model=schemas.User)
...
@router.get("/", dependencies=[Depends(get_current_active_superuser)], response_model=List[schemas.User])
